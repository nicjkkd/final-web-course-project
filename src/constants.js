...
import the_shawshank_redemption from "./assets/the_shawshank_redemption.jpg";
import pulp_fiction from "./assets/pulp_fiction.jpg";
import titanic from "./assets/titanic.jpg";
import gladiator from "./assets/gladiator.jpg";
import shindler from "./assets/shindler's_list.jpg";
import star_wars from "./assets/star_wars_empire_strikes_back.jpg";
import la_la_land from "./assets/lalaland.jpg";
import parasite from "./assets/parasite.jpg";
import social_network from "./assets/social_network.jpg";
...
export const MOVIES = [
  ...
  },
  {
    ...
    description:
      "Історія створення Facebook і конфліктів, що виникли між засновниками.",
    genre: "Драма, Біографія",
    poster: social_network,
    session: "2025-04-23T18:30",
  },
  {
    id: 16,
    title: "Воно",
    description:
      "Група дітей протистоїть зловісному клоуну Пеннівайзу, який тероризує їхнє місто.",
    genre: "Жахи, Трилер",
    poster: it,
